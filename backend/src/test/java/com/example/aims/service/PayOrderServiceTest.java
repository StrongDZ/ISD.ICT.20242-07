...
class PayOrderServiceTest {
    ...
    // PaymentTransaction paymentTransaction =
    // payOrderService.getPaymentTransactionByOrderId(orderId);
    ...
    // PaymentTransaction paymentTransaction =
    // payOrderService.getPaymentTransactionByOrderId("ORD002");
    ...
    // assertEquals("Order is not in PENDING state for payment. Current status:
    // APPROVED", exception.getMessage());
    // }
}