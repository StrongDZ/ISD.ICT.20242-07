...
const CartPage = () => {
    ...
    const { cartItems, updateCartItem, removeFromCart, clearCart, getCartTotal, getCartCount, getTotalExcludingVAT, getVATAmount } = useCart();
                ...
                <Grid item xs={12} md={4}>
                    <Card sx={{ position: "sticky", top: 24 }}>
                        <CardContent>
                            ...
                            <Button variant="contained" fullWidth size="large" onClick={handleCheckout} endIcon={<ArrowForward />} sx={{ mb: 2 }}>
                                Proceed to Checkout
                            </Button>
