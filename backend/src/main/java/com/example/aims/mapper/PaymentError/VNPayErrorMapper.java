...
@Component
public class VNPayErrorMapper implements IPaymentErrorMapper {
    ...
    /**
     * Handles different response codes from VNPay payment gateway and throws
     * appropriate exceptions.
     * 
     * @param responseCode The response code from VNPay payment gateway.
